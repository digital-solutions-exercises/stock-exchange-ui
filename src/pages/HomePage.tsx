...
const HomePage = () => {
  ...
  return (
    <div
      ...
      className={`col-span-3 row-span-7 grid grid-cols-3 grid-rows-6 gap-6 p-6 sm:pl-10 sm:pr-10 ${darkTheme ? "bg-gray-900 text-gray-300" : "bg-neutral-100"}`}
    >
      <div className="col-span-3 row-span-1 flex justify-start items-center">
        <ChartHeader name={quote.longName || quote.shortName} />
      </div>
      <div className="col-span-3 sm:col-span-2 row-span-6">
        <Chart />
      </div>
