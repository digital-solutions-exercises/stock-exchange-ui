  ...
  return (
    <div className="overflow-hidden">
      <div className="flex justify-center space-x-4">
        <button
          data-testid="previous-button-id"
          onClick={prevSlide}
          className="border border-solid border-indigo-600 w-10 h-10 rounded-full flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-colors"
        >
          <svg
          ...
          <div key={slide.id} className="w-full flex-shrink-0">
            <div className="p-4 relative">
              <img
                src={slide.imageUrl}
                alt={slide.title}
                className="rounded-2xl w-full max-h-96 lg:max-h-40 xl:max-h-56 2xl:max-h-72 object-cover"
              />
              <h3
